"""Full regression gate for M4.2 procedural memory.
...
def run_full_gate(
    *,
    ...
    """Run the M4.2 full gate and write a compact report."""
    ...
    summary = {
        "name": "M4.2 Procedural Memory Full Gate",
...
def _write_gate_summary(gate_dir: Path, summary: dict[str, Any], env: dict[str, str]) -> None:
    ...
    report_file = gate_dir / "m4.2-procedural-memory-report.md"
...
def _render_report(summary: dict[str, Any]) -> str:
    lines = [
        "# M4.2 Procedural Memory Full Gate Report",
        "",
...
def _parse_args(argv: Sequence[str]) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        ...
        description="Run the M4.2 procedural memory full gate",
    )
