...
class Agent:
    def __init__(
        ...
        metatools: bool = False,
        metatool_dir: Any | None = None,
        ...
        self.metatools_enabled = metatools
        ...
        self.metatools = MetaToolManager(
            self.tools, self.emitter, base_dir=metatool_dir
        ) if metatools else None
        if self.metatools is not None:
            self.metatools.load_all()
        ...
        if self.session.head is None:
            self.session.append({
                ...
                "content": build_system_prompt(
                    ...
                    metatools=self.metatools_enabled,
                ),
            })
