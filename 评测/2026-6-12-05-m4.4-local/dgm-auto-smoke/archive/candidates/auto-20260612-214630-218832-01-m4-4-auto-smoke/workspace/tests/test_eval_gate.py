    ...
    report = eval_gate._render_report(
        {
            ...
            "checks": [
                ...
                },
                {
                    ...
                    "generated_count": 2,
                    "passed_count": 2,
                    "best_candidate_id": "auto-best",
                    "summary_json_file": "/tmp/gate/auto-summary.json",
                },
                {
...
def test_run_full_gate_fixed_root_is_repeatable(tmp_path, monkeypatch):
    ...
    assert any(c["name"] == "dgm_auto_fake_agent_smoke" and c["passed"] for c in second["checks"])
